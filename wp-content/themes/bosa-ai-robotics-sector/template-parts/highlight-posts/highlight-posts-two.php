					...
					<div class="slide-item">
						...
						<div class="slide-inner">
							<article id="post-<?php the_ID(); ?>" <?php post_class( $bosa_ai_robotics_sector_noThumbnail ) ?>>
								<?php
					        	$bosa_ai_robotics_sector_highlight_two_size = 'bosa-ai-robotics-sector-420-300';
					        	...
					        	if ( empty( $bosa_ai_robotics_sector_render_highlight_post_image_size ) ){
					        		$bosa_ai_robotics_sector_render_highlight_post_image_size = $bosa_ai_robotics_sector_highlight_two_size;
					        	}
