<header id="masthead" class="site-header header-fourteen">
	<div class="top-header">
					...
					<div class="container">
						<div class="row align-items-center">
										...
										<ul>
											<li>
												<?php if( get_theme_mod( 'bosa_ai_robotics_sector_contact_email', '' ) ){ ?>
													<a href="<?php echo esc_url( 'mailto:' . get_theme_mod( 'bosa_ai_robotics_sector_contact_email', '' ) ); ?>">
							...
							<div class="col-lg-6 d-none d-lg-flex justify-content-end align-items-center">
								...
								<?php if( !get_theme_mod( 'bosa_ai_robotics_sector_disable_header_button', false ) && bosa_ai_robotics_sector_has_header_buttons() ){
									echo '<div class="header-btn">';
										bosa_ai_robotics_sector_header_buttons();
									echo '</div>';
								} ?>
							</div>
						</div>
		...
		<?php if( !get_theme_mod( 'bosa_ai_robotics_sector_disable_mobile_top_header', false ) ){ ?>
			<?php if( ( !get_theme_mod( 'bosa_ai_robotics_sector_disable_header_social_links', false ) && bosa_ai_robotics_sector_has_social() ) || ( !get_theme_mod( 'bosa_ai_robotics_sector_disable_contact_detail', false ) && ( get_theme_mod( 'bosa_ai_robotics_sector_contact_phone', '' )  || get_theme_mod( 'bosa_ai_robotics_sector_contact_email', '' )  || get_theme_mod( 'bosa_ai_robotics_sector_contact_address', '' ) ) ) || !get_theme_mod( 'bosa_ai_robotics_sector_disable_search_icon', false ) || ( !get_theme_mod( 'bosa_ai_robotics_sector_disable_header_button', false ) && bosa_ai_robotics_sector_has_header_buttons() ) || is_active_sidebar( 'menu-sidebar' ) ){ ?>
			...
			<div class="row align-items-center">
				...
				<div class="col-lg-9 d-none d-lg-block">
					<div class="main-navigation-wrap">
						...
						<?php if( get_theme_mod( 'bosa_ai_robotics_sector_contact_phone', '' ) && !get_theme_mod( 'bosa_ai_robotics_sector_disable_contact_detail', false ) ){ ?>
							<div class="bottom-contact">
								<a href="<?php echo esc_url( 'tel:' . get_theme_mod( 'bosa_ai_robotics_sector_contact_phone', '' ) ); ?>">
									<i class="fa-solid fa-phone"></i>
									<span><?php echo esc_html( get_theme_mod( 'bosa_ai_robotics_sector_header_phone_label', '' ) ); ?></span>
